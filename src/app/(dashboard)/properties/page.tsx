        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-4 py-16">
            ...
            <div className="text-center">
              <p className="font-medium">Ajoutez votre premier logement</p>
              <p className="mt-1 text-sm text-muted-foreground">Commencez par ajouter un logement pour suivre sa rentabilite</p>
            </div>
            <Button asChild className="bg-amber-500 hover:bg-amber-400">
