...
| Tests | **Vitest** + Testing Library | 248 tests, ~20s, CI GitHub Actions |
...
> **Résultat** : T2 République en tête (94.7%), Loft Oberkampf en dernier (-1539% — le loyer dépasse largement les revenus).
